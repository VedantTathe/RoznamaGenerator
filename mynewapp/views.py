...
#         df.to_excel(excel_path, index=False)
    ...
    #     return render(request, 'pdf_downloaded.html', {'excel_path': excel_path, 'myurl': 'PDF read to Excel successfully', 'path': download_dir})
...
# def fill_roznama_excel(request):
#     download_dir = os.path.join(BASE_DIR, 'downloads')
#     filename = os.path.join(download_dir, 'Court_Case_info_format_Davane_sir.xlsx')
...
#     if len(common_numbers) == 0:
#         extracted_data['message'] = "Application Numbers Not Matched...!"
#         return render(request, "roznama_updated.html", extracted_data)
...
#     if res == True:    
#         extracted_data['message'] = "Roznama Updated Successfully!"
#     else:
#         extracted_data['message'] = "Something went wrong..!\n Required Columns Not found in roznama excel"
